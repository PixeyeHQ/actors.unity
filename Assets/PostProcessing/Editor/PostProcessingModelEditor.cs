    ...
    public class PostProcessingModelEditor
    {
        ...
        internal void OnGUI()
        {
            ...
            var display = alwaysEnabled
                ? EditorGUIHelper.Header(serializedProperty.displayName + "   TEST", m_SettingsProperty, Reset)
                : EditorGUIHelper.Header(serializedProperty.displayName + "   HA", m_SettingsProperty, m_EnabledProperty, Reset);
