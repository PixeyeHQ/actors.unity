...
namespace Pixeye.Framework
{
	public static partial class HelperFramework
	{
		...
		public static Transform Spawn(this object o, string prefabID, Transform parent, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
		...
		public static T Spawn<T>(this object o, int poolID, GameObject prefab, Transform parent, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
			go.position = startPosition;
			go.localRotation = startRotation;
		...
		public static Transform Spawn(this object o, int poolID, string prefabID, Transform parent, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var prefab = Box.Get<GameObject>(prefabID);
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
			go.position = startPosition;
		...
		public static T Spawn<T>(this object o, int poolID, string prefabID, Transform parent, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var prefab = Box.Get<GameObject>(prefabID);
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
			go.position = startPosition;
		...
		public static Transform Spawn(this object o, int poolID, GameObject prefab, string parentID, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var parent = ProcessorScene.Get(parentID);
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
			go.position = startPosition;
		...
		public static T Spawn<T>(this object o, int poolID, GameObject prefab, string parentID, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var parent = ProcessorScene.Get(parentID);
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
			go.position = startPosition;
		...
		public static Transform Spawn(this object o, int poolID, string prefabID, string parentID, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var parent = ProcessorScene.Get(parentID);
			var prefab = Box.Get<GameObject>(prefabID);
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
		...
		public static T Spawn<T>(this object o, int poolID, string prefabID, string parentID, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var parent = ProcessorScene.Get(parentID);
			var prefab = Box.Get<GameObject>(prefabID);
			var go = HandlePool.pools[poolID].Spawn(prefab, parent).transform;
		...
		public static Transform Spawn(this object o, int poolID, GameObject prefab, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
		...
		public static T Spawn<T>(this object o, int poolID, GameObject prefab, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var go = HandlePool.pools[poolID].Spawn(prefab).transform;
			go.localPosition = startPosition;
			go.localRotation = startRotation;
		...
		public static Transform Spawn(this object o, int poolID, string prefabID, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var prefab = Box.Get<GameObject>(prefabID);
			var go = HandlePool.pools[poolID].Spawn(prefab).transform;
			go.localPosition = startPosition;
		...
		public static T Spawn<T>(this object o, int poolID, string prefabID, Vector3 startPosition = default(Vector3), Quaternion startRotation = default(Quaternion))
		{
			var prefab = Box.Get<GameObject>(prefabID);
			var go = HandlePool.pools[poolID].Spawn(prefab).transform;
			go.localPosition = startPosition;
