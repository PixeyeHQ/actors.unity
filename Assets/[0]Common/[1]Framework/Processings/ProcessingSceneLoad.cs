...
namespace Homebrew
{
	public class ProcessingSceneLoad
	{
		...
		private DataScenesList _dataScenesList;
		...
		{
			if (_dataScenesList == null) _dataScenesList = Resources.Load<DataScenesList>("ScenesList");
			return _dataScenesList.scenesNames[index];
		}
