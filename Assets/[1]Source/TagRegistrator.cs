...
public class TagRegistrator : MonoBehaviour
{
    ...
    static string path = dir + @"\Assets\[1]Source\Tags";
    ...
    ///<summary>
    /// Регистрация тегов со значениями = 0
    ///</summary>
    ...
    ///<summary>
    /// Сброс всех тегов и повторная регистрация тегов со значениями = 0
    ///</summary>
    ...
    ///<summary>
    /// Сброс счетчика тегов (регистрация тегов начнется с 1)
    ///</summary>
