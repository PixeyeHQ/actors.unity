...
{
  public class PostHandleActors : EndNameEditAction
  {
    public const string PATH_TO_TEMPLATE = @"Assets\Actors\Editor\Templates\TmpActor.txt";
    ...
    [MenuItem("Assets/Create/Actors/Actor", false, MENU_ITEM_PRIORITY)]
    public static void CreateSample()
    {
      ...
      if (path == string.Empty)
        ...
        path = string.Format($"{path}/Editor/Templates/TmpActor.txt");

      CreateFromTemplate("ActorDefault.cs", path);
    }
    ...
    public override void Action(int instanceId, string pathName, string resourceFile)
    {
      ...
      AssetDatabase.SetLabels(o, new[] {"Actor"});
