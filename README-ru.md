...
2) Код логики становится не только чище, но и модульным. Отключив можуль обработки урона даже если сигналы будут отправляться обрабатывать их будет некому. 
